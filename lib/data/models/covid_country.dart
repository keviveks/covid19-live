class CovidCountryList {
  List<CovidCountry> countries;

  CovidCountryList({ this.countries });

  CovidCountryList.fromJson(List<dynamic> parsedJson) {
    if (parsedJson != null) {
      countries = List<CovidCountry>();
      countries = parsedJson.map((c) => CovidCountry.fromJson(c)).toList();
    }
  }
}
